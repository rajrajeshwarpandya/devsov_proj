I am using single knn model as my base for testing knn accuracy varies from 75% to 85%, i used dataset.py to divide the dataset and convert text based ans into numerical 
